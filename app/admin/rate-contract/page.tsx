...
export default function ItemwiseRCPage() {
  ...
  useEffect(() => {
    ...
    if (saved) {
      ...
      const defaultContract: ItemwiseRC = {
        id: 1,
        indentNo: "IND-2023-100",
        item: "Amoxicillin",
        dosage: "Capsule 250 mg",
        packSize: "10x10",
        l1Rate: "₹120.00",
        bidder: "XYZ Pharma Ltd.",
      };
      setContracts([defaultContract]);
      localStorage.setItem("itemwise_rc", JSON.stringify([defaultContract]));
    }
  }, []);
  ...
  useEffect(() => {
    if (contracts.length > 0) {
      localStorage.setItem("itemwise_rc", JSON.stringify(contracts));
    }
  }, [contracts]);
