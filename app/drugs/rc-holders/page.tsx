...
export default function RcHoldersPage() {
  ...
  // filter logic
  const filtered = rcHolders.filter((r) =>
    [r.item, r.dosage, r.bidder]
      .join(" ")
      .toLowerCase()
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-10">
      ...
      {/* ✅ Fixed hydration issue + defined searchTerm */}
      <input
        ...
        className="mb-6 w-full md:w-1/3 rounded-lg border px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500"
      />
