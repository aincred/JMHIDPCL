// app/equipment/terms/page.tsx

export default function EquipmentTermsPage() {
  return (
      ...
      <div className="max-w-6xl mx-auto bg-white dark:bg-gray-800 shadow-xl rounded-2xl overflow-hidden">
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6 border-b border-gray-200 dark:border-gray-700">
          <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-gray-100">
            Terms & Conditions of Procurement of Equipment
          </h1>
          <p className="mt-2 text-sm sm:text-base text-gray-600 dark:text-gray-300">
            View or download the official Terms & Conditions for equipment procurement below.
          </p>
        </div>
        ...
        <div className="p-4 sm:p-6">
          <div className="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 shadow-md">
            <iframe
              src="/Term_and_Condition_of_procurment_equipments.pdf" // Place your PDF here: public/equipment-terms.pdf
          ...
          <div className="mt-6 text-center">
            <a
              href="/Term_and_Condition_of_procurment_equipments.pdf"
              download
            ...
            >
              Download Equipment Procurement Terms
            </a>
          </div>
        </div>
      </div>
